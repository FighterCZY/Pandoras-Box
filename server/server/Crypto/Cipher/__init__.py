...
if sys.platform == "cli":
    ...
    import IronPyCrypto_Cipher_AES as AES
    import IronPyCrypto_Cipher_ARC2 as ARC2
    import IronPyCrypto_Cipher_ARC4 as ARC4
    import IronPyCrypto_Cipher_Blowfish as Blowfish
    import IronPyCrypto_Cipher_CAST as CAST
    import IronPyCrypto_Cipher_DES as DES
    import IronPyCrypto_Cipher_DES3 as DES3
    import IronPyCrypto_Cipher_XOR as XOR
